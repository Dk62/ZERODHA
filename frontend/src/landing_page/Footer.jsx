  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col" >
          <p className="head-p text-dark " style={{fontSize:"20px", fontWeight:"500"}}>Accounts</p>
        ...
        <div className="col">
          <p className="head-p text-dark " style={{fontSize:"20px", fontWeight:"500"}}>Support</p>
          <a href=""> Contact us</a>
          <br /><br />
        ...
        <div className="col">
          <p className="head-p text-dark " style={{fontSize:"20px", fontWeight:"500"}}>Company</p>
          <a href="">About</a>
          <br /><br />
          <a href="">Philosophy</a>
          <br /><br />
        ...
        <div className="col">
          <p className="head-p text-dark " style={{fontSize:"20px", fontWeight:500}}>Quick Link</p>
      ...
      <div  className="last-footer mb-5"style={{margin:"0px 20px 0px 0px", display:"flex", }}>
        <a href="/">NSE</a>&nbsp; &nbsp;
        <a href="/">BSE</a>&nbsp; &nbsp;
        <a href="/">MCX</a>&nbsp; &nbsp;
